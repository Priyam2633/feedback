...
<html>
  ...
  <body>
      ...
      <form action="php/feedback.php" method="post" class="student-form">
        <div class="student-details">
          ...
          <select name="subject" id="subject">
            ...
            <option value="AS">Maths</option>
            <option value="AS">Maths 2 </option>
        ...
        <div class="student-feedback">
          ...
          <!-- Question 2-iii -->
          <h4>
            iii. completes syllabus on time ?
          </h4>
          <label>
            <input type="radio" id="ques-2iii-4" name="ques-2iii" value="5" />
            5- Excellent
          </label>
          <label>
    ...
    <div class="copyright-text">
      <p>© Copyright Priyam_Prashant-131 2024</p>
    </div>
  </body>
</html>
